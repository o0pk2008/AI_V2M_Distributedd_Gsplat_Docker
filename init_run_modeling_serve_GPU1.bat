...
docker run --rm -it --gpus all ^
  ...
  -p 5201:5201 ^
  %IMAGE_NAME% ^
  /bin/bash -c "source /root/miniconda3/etc/profile.d/conda.sh && conda activate nerfstudio && cd %CONTAINER_PATH%/AI_V2M_GPU_Serve && python3 modeling_serve.py --port 5201"
